...
function setup() {
  ...
  numAngles = 12; // Number of potential angles to turn to (e.g., 4 for up, down, left, right; 8 for adding diagonals)
}
...
function draw() {
  ...
  let trailThickness = 5; // Increase trail thickness
  let trailOffset = 2; // Increase offset for black lines
